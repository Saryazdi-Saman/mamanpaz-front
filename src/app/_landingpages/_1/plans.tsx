import { Logo, LogoIcon } from "@/assets/svg";
    ...
    return (
        <section className="py-24 px-16">
            <header className="w-fit mx-auto">
                <h1 className="text-5xl font-medium">Our <span className="font-bold italic">Simple and Easy</span> Pricing</h1>
            </header>
            <ul className="py-10 max-w-7xl flex flex-row gap-6 mx-auto">
