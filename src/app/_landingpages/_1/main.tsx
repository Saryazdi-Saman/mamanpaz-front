...
import { DeliveryIcon, Logo } from "@/assets/svg";
...
export default function Landing1() {
    ...
    return (
        <div className="h-[calc(100svh-4rem)] flex flex-col snap-end">
            <section className="hero relative flex-grow bg-background">
                <div className="hero-content flex-grow h-full w-full relative py-6 px-16">
                    <Image
                        src={heroImage}
            ...
            <section className="stats h-fit px-16 w-full bg-background pb-16 pt-6">
